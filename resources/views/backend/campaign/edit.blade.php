                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                              method="post" action="{{ route('backend.campaign.update', $item->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control" name="type">
                                        <option @if($item->type == 1)
                                                    {{ 'selected' }}
                                                @endif value="1">Menu</option>
                                        <option @if($item->type == 2)
                                                    {{ 'selected' }}
                                                    @endif value="2">Body</option>
                                    </select>
                                </div>
                            </div>
                            <div class="item form-group">
