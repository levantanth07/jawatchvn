...
@section('title','Thêm mới phản hồi')
@section('content')
    <div class="">
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                              method="post" action="{{ route('backend.feedback.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea cols="3" rows="5" name="content" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="item form-group">
