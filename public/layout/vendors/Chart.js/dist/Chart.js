...
module.exports = function(Chart) {
	...
	// The mylayouts service is very self explanatory.  It's responsible for the mylayouts within a chart.
	// Scales, Legends and Plugins all rely on the mylayouts service and can easily register to be placed anywhere they need
	// It is this service's responsibility of carrying out that mylayouts.
	Chart.layoutService = {
		defaults: {},

		// Register a box to a chartInstance. A box is simply a reference to an object that requires mylayouts. eg. Scales, Legend, Plugins.
		...
		update: function(chartInstance, width, height) {
			...
			// 4. Give each mylayouts the maximum size it can be. The mylayouts will return it's minimum size
			...
			// Let the left mylayouts know the final margin
			...
			// Recalculate because the size of each mylayouts might have changed slightly due to the margins (label rotation for instance)
			...
			// Figure out if our chart area changed. This would occur if the dataset mylayouts label rotation
