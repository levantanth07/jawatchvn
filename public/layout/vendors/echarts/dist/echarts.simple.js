...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var ComponentModel = Model.extend({
	        ...
	        /**
	         * Support merge mylayouts params.
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Layout helpers for each component positioning
	     ...
	     *     init: function () {
	     *         ...
	     *         var inputPositionParams = mylayouts.getLayoutParams(option);
	     *         this.mergeOption(inputPositionParams);
	     *     },
	     *     mergeOption: function (newOption) {
	     *         newOption && zrUtil.merge(thisOption, newOption, true);
	     *         mylayouts.mergeLayoutParam(thisOption, newOption);
	     *     }
	     * });
	     *
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var List = function (dimensions, hostModel) {
	        ...
	        /**
	         * Item mylayouts properties after mylayouts
	         * @type {Array.<Object>}
	         * @private
	         */
	        this._itemLayouts = [];
	    ...
	    /**
	     * Get mylayouts of single data item
	     * @param {number} idx
	     */
	    ...
	    /**
	     * Set mylayouts of single data item
	     * @param {number} idx
	     * @param {Object} layout
	    ...
	    /**
	     * Clear all mylayouts of single data item
	     */
	    ...
	    /**
	     * Shallow clone a new list except visual and mylayouts properties, and graph elements.
	...
	// FIXME emphasis label position is not same with normal label position
	    ...
	    module.exports = function (seriesModel, r, viewWidth, viewHeight) {
	        ...
	        data.each(function (idx) {
	            ...
	            // Not mylayouts the inside label
	            if (!isLabelInside) {
