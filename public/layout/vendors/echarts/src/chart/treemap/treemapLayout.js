define(function (require) {
    ...
    function update(ecModel, api, payload) {
        ...
        ecModel.eachComponent(condition, function (seriesModel) {
            ...
            if (payloadType !== 'treemapMove') {
                ...
                // mylayouts should be cleared because using updateView but not update.
                viewRoot.hostTree.clearLayouts();

                // TODO
                // optimize: if out of view clip, do not mylayouts.
    ...
    function initChildren(node, nodeModel, totalArea, options, hideChildren, depth) {
        ...
        for (var i = 0, len = viewChildren.length; i < len; i++) {
            ...
            // Do not use setLayout({...}, true), because it is needed to clear last mylayouts.
    ...
    // Prunning depends on mylayouts and root position, so we have to do it after mylayouts.
    function prunning(node, clipRect, viewAbovePath, viewRoot, depth) {
        ...
        node.setLayout({
            ...
            // see but still mylayouts for animation preparation but not render.
